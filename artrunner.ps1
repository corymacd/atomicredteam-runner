...
if($IsWindows = $true) { $PSDefaultParameterValues = @{"Invoke-AtomicTest:PathToAtomicsFolder"="C:\AtomicRedTeam\atomics"}}
...
$modules_to_run = "T1003.002","T1003.003","T1003.008", "T1003.007", "T1552.003", "T1552.004"
